    ...
    componentDidMount() {
        ...
        axios.get("https://react-my-burger-f6374.firebaseio.com/ingredients.json" ).then(response => {
            ...
            this.setState({
                ...
                questionIndex: questionnaireConfig.questions.indexOf(questionnaireConfig.questions.find(question => question.selectedAnswers.length === 0)),
                loading: false
            })
        });
